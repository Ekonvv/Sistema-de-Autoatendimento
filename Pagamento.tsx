...
export function Pagamento({ cart, onVoltar, onConfirmar }: PagamentoProps) {
  ...
  function podePagar(): boolean {
    ...
    if (!nome.trim()) return false; // nome sempre obrigatório
    ...
    if (metodo === "pix") {
      return chavePix.trim().length > 0;
    }

    // dinheiro e vale: só o nome já basta
    return true;
  }
      ...
      <div className={styles.conteudo}>
        ...
        <div className={styles.nota}>
          <div className={styles.notaCabecalho}>
            ...
            <p>Rua das Hambúrgueres, 123 — São Paulo/SP</p>
            <p className={styles.notaNumero}>
              {numeroNota} · {agora}
            </p>
